    ...
    <div class="container">
        <div class="product-details">
            ...
            @method('PUT')
                <table>
                    <tr>
                        <th>Kode Barang</th>
                        <td>{{ $data1->KodeBarang }}</td>
                    </tr>
                    <tr>
                        <th>Nama</th>
                        <td><input type="text" class="form-control" name="Nama" value="{{ $data1->Nama }}" id="Nama" required></td>
                    </tr>
                    <tr>
                        <th>Satuan</th>
                        <td><input type="text" class="form-control" name="Satuan" value="{{ $data1->Satuan }}" id="Satuan" required></td>
                    </tr>
                    <tr>
                        <th>Harga Beli</th>
                        <td><input type="number" step="0.01" class="form-control" name="HargaBeli" value="{{ $data1->HargaBeli }}" id="HargaBeli" required></td>
                    </tr>
                    <tr>
                        <th>Harga Jual</th>
                        <td><input type="number" step="0.01" class="form-control" name="HargaJual" value="{{ $data1->HargaJual }}" id="HargaJual" required></td>
                    </tr>
                    <tr>
                        <th>Barcode</th>
                        <td><input type="number" class="form-control" name="Barcode" value="{{ $data1->Barcode }}" id="Barcode" required></td>
                    </tr>
                </table>
        </div>
        <div class="input-stock">
            ...
            <div class="quantity-controls">
                ...
                <input type="number" name="Stok" id="quantity" value="{{ $data1->Stok }}" min="0" required>
